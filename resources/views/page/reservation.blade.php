                ...
                <form id="reserveForm" action="{{ route('page.reservation.save') }}" method="POST" class="form">
                    ...
                    <div id="mw_wp_form_mw-wp-form-59" class="mw_wp_form mw_wp_form_input  ">
                        ...
                        <dl>
                            ...
                            <dd>
                                <input type="text" name="reserve_name" value="" placeholder="例)　田中" class="wide" data-prompt-position="topLeft" required>
                            </dd>
                        </dl>
                        <dl>
                            <dt>メールアドレス<span>必須</span></dt>
                            <dd>
                                <input type="email" name="reserve_mail" value="" placeholder="例)　xxx-xxx@xxxxx.ne.jp" class="wide" id="reserveMail" data-prompt-position="topLeft" required>
                            </dd>
                        </dl>
                        <dl>
                            <dt>メールアドレス(確認用)<span>必須</span></dt>
                            <dd>
                                <input type="email" name="reserve_mail2" value="" placeholder="確認のため再度ご入力ください" class="wide" data-prompt-position="topLeft" required>
                            </dd>
                        </dl>
                        <dl>
                            <dt>お電話番号<span>必須</span></dt>
                            <dd>
                                <input type="text" name="reserve_tel" value="" placeholder="例)　080-1234-5678" class="tel wide" data-prompt-position="topLeft" required>
                            </dd>
                        </dl>
                        <dl>
                            <dt>LINE ID</dt>
