            ...
            <div class="tile-stats tile-primary"> 
                ...
                <form method="post" action="{{ route('user.register.save') }}" role="form" id="form_register">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-addon text-light"><i class="entypo-user"></i> </div> 
                            <input type="text" class="form-control" name="line_id" placeholder="{{__('Line ID')}}" autocomplete="off" required />
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-addon text-light"><i class="entypo-user"></i> </div> 
                            <input type="text" class="form-control" name="lady1" placeholder="{{__('Lady 1')}}" autocomplete="off" required />
                            @if ($errors->has('lady1'))
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <div class="date-and-time"> 
                                <input type="text" name="date1" class="form-control datepicker" data-format="yyyy-mm-dd" value="{{ $today }}"> 
                                <input type="text" name="time1" class="form-control timepicker" data-template="dropdown" data-show-seconds="true" data-default-time="11:25 AM"
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-addon text-light"><i class="entypo-user"></i> </div> 
                            <input type="text" class="form-control" name="lady2" placeholder="{{__('Lady 2')}}" autocomplete="off" required />
                            @if ($errors->has('lady2'))
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <div class="date-and-time"> 
                                <input type="text" name="date2" class="form-control datepicker" data-format="yyyy-mm-dd" value="{{ $today }}"> 
                                <input type="text" name="time2" class="form-control timepicker" data-template="dropdown" data-show-seconds="true" data-default-time="11:25 AM"
                                                    data-show-meridian="true" data-minute-step="5" data-second-step="5" value="{{ $time }}" />
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-addon text-light"><i class="entypo-user"></i> </div> 
                            <input type="text" class="form-control" name="lady3" placeholder="{{__('Lady 3')}}" autocomplete="off" required />
                            @if ($errors->has('lady3'))
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <div class="date-and-time"> 
                                <input type="text" name="date3" class="form-control datepicker" data-format="yyyy-mm-dd" value="{{ $today }}"> 
                                <input type="text" name="time3" class="form-control timepicker" data-template="dropdown" data-show-seconds="true" data-default-time="11:25 AM"
                                                    data-show-meridian="true" data-minute-step="5" data-second-step="5" value="{{ $time }}" />
                            </div>
                        </div>
                    </div>
