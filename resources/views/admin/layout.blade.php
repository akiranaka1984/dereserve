...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ url('/assets/css/neon-core.css') }}?v=1.2" >
        <link rel="stylesheet" href="{{ url('/assets/css/neon-theme.css') }}?v=1.2" >
        <link rel="stylesheet" href="{{ url('/assets/css/neon-forms.css') }}?v=1.2" >
        <link rel="stylesheet" href="{{ url('/assets/css/custom.css') }}?v=1.2" >
